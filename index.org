...
#+ATTR_HTML: :src images/unixfs_merkle_dag.png
[[file:images/unixfs_merkle_dag.png][file:/media/PNYProElite/etudes/alyra/veille_ipfs/images/unixfs_merkle_dag.png]]
...
[[https://asciinema.org/a/zeX2zXSsrs5h4jb9BSGyF6rzs][asciinema]]

#+ATTR_HTML: :src images/ipfs_get.gif
[[file:images/ipfs_get.gif][file:/media/PNYProElite/etudes/alyra/veille_ipfs/images/ipfs_get.gif]]
...
[[https://asciinema.org/a/93ouTibKknyK1bB8eF4EINKRz][asciinema]]

#+ATTR_HTML: :src images/ipfs_pin.gif
[[file:images/ipfs_pin.gif][file:/media/PNYProElite/etudes/alyra/veille_ipfs/images/ipfs_pin.gif]]

* V - Advanced Concepts

** Multiformats

- https://multiformats.io/ ( [[https://github.com/multiformats][gh]] )
- [[https://docs.google.com/presentation/d/1wyrTNTERJV23R7PyLrNloBauygdq1SXerijvEUG62xI/edit#slide=id.g62101298e7_9_382][Gdoc]]

** Multicodec

A fixed number is assigned to a protocol, format, concept, ...

** 

[[https://ipfs.io/ipfs/QmXec1jjwzxWJoNbxQF5KffL8q6hFXm9QwUGaa3wKGk6dT/#title=Multicodecs&src=https://raw.githubusercontent.com/multiformats/multicodec/master/table.csv][Viewer]]

#+ATTR_HTML: :src images/multicodec.png
[[file:images/multicodec.png][file:/media/PNYProElite/etudes/alyra/veille_ipfs/images/multicodec.png]]

** Multihash

Triple of (hash function, hash length, hash digest).

#+ATTR_HTML: :src images/multihash.png
[[file:images/multihash.png][file:/media/PNYProElite/etudes/alyra/veille_ipfs/images/multihash.png]]

** Multibase

#+ATTR_HTML: :src images/multibase.png
[[file:images/multibase.png][file:/media/PNYProElite/etudes/alyra/veille_ipfs/images/multibase.png]]

** Cluster

[[https://cluster.ipfs.io/][IPFS Cluster]]

#+ATTR_HTML: :src images/ipfs_cluster.png
[[file:images/ipfs_cluster.png][file:/media/PNYProElite/etudes/alyra/veille_ipfs/images/ipfs_cluster.png]]

** IPNS

[[https://docs.ipfs.io/concepts/ipns/][IPNS Doc]]

#+ATTR_HTML: :src images/ipns_public_key.png
[[file:images/ipns_public_key.png][file:/media/PNYProElite/etudes/alyra/veille_ipfs/images/ipns_public_key.png]]
...
#+ATTR_HTML: :src images/remix_publish_from_compiler_button.png
[[file:images/remix_publish_from_compiler_button.png][file:/media/PNYProElite/etudes/alyra/veille_ipfs/images/remix_publish_from_compiler_button.png]]

#+ATTR_HTML: :src images/remix_publish_from_compiler_modal.png
[[file:images/remix_publish_from_compiler_modal.png][file:/media/PNYProElite/etudes/alyra/veille_ipfs/images/remix_publish_from_compiler_modal.png]]

** 

#+ATTR_HTML: :src images/remix_publish_from_deploy_checkbox.png
[[file:images/remix_publish_from_deploy_checkbox.png][file:/media/PNYProElite/etudes/alyra/veille_ipfs/images/remix_publish_from_deploy_checkbox.png]]
...
- [[https://pinata.cloud/][Pinata]]
- [[https://www.eternum.io/][Eternum]]
...
#+ATTR_HTML: :src images/functional-dapp-architecture.png
[[file:images/functional-dapp-architecture.png][file:/media/PNYProElite/etudes/alyra/veille_ipfs/images/functional-dapp-architecture.png]]

** 

#+ATTR_HTML: :src images/functional-dapp-architecture-ipfs.png
[[file:images/functional-dapp-architecture-ipfs.png][file:/media/PNYProElite/etudes/alyra/veille_ipfs/images/functional-dapp-architecture-ipfs.png]]
